...
exports.run = (client, message, args) => {
  ...
  if (message.mentions.users.size < 1) return message.reply('Kimi sunucudan ataca?ını yazmalısın.').catch(console.error);
...
exports.help = {
  name: 'kick',
  description: 'İstedi?iniz ki?iyi sunucudan atar.',
